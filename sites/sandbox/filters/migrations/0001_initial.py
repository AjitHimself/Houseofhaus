...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'filters_filtertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filters', to=orm['catalogue.Category'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
        ))
        db.send_create_signal(u'filters', ['FilterType'])

        # Adding model 'FilterOption'
        db.create_table(u'filters_filteroption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filters', self.gf('django.db.models.fields.related.ForeignKey')(related_name='options', to=orm['filters.FilterType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
        ))
        db.send_create_signal(u'filters', ['FilterOption'])

        # Adding model 'ProductFilter'
        db.create_table(u'filters_productfilter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filters', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filters.FilterType'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filters', to=orm['catalogue.Product'])),
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filters.FilterOption'])),
        ))
        db.send_create_signal(u'filters', ['ProductFilter'])

        # Adding unique constraint on 'ProductFilter', fields ['filters', 'product']
        db.create_unique(u'filters_productfilter', ['filters_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductFilter', fields ['filters', 'product']
        db.delete_unique(u'filters_productfilter', ['filters_id', 'product_id'])

        # Deleting model 'FilterType'
        db.delete_table(u'filters_filtertype')

        # Deleting model 'FilterOption'
        db.delete_table(u'filters_filteroption')

        # Deleting model 'ProductFilter'
        db.delete_table(u'filters_productfilter')
    ...
    models = {
        ...
        u'filters.filteroption': {
            'Meta': {'object_name': 'FilterOption'},
            'filters': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'options'", 'to': u"orm['filters.FilterType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'})
        },
        u'filters.filtertype': {
            'Meta': {'object_name': 'FilterType'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filters'", 'to': u"orm['catalogue.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'})
        },
        u'filters.productfilter': {
            'Meta': {'unique_together': "(('filters', 'product'),)", 'object_name': 'ProductFilter'},
            'filters': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['filters.FilterType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['filters.FilterOption']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filters'", 'to': u"orm['catalogue.Product']"})
        }
    }

    complete_apps = ['filters']