...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StockRecord.deposit_value'
        db.delete_column(u'partner_stockrecord', 'deposit_value')


    def backwards(self, orm):
        # Adding field 'StockRecord.deposit_value'
        db.add_column(u'partner_stockrecord', 'deposit_value',
