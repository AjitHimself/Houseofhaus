...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockRecord.rent_count'
        db.add_column(u'partner_stockrecord', 'rent_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StockRecord.no_of_rent'
        db.add_column(u'partner_stockrecord', 'no_of_rent',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Deleting field 'StockRecord.rent_count'
        db.delete_column(u'partner_stockrecord', 'rent_count')
