...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StockRecord.rent_deposit'
        db.delete_column(u'partner_stockrecord', 'rent_deposit')


    def backwards(self, orm):
        # Adding field 'StockRecord.rent_deposit'
        db.add_column(u'partner_stockrecord', 'rent_deposit',
