...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rent_rent', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Users'], unique=True, null=True, blank=True)),
            ('stock_record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['partner.StockRecord'], null=True, blank=True)),
    ...
    models = {
        ...
        u'rent.rent': {
            ...
            'stock_record': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['partner.StockRecord']", 'null': 'True', 'blank': 'True'})
        }
    }
