...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rent.product'
        db.add_column(u'rent_rent', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Rent.end_date'
        db.alter_column(u'rent_rent', 'end_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Rent.product'
        db.delete_column(u'rent_rent', 'product_id')


        # Changing field 'Rent.end_date'
        db.alter_column(u'rent_rent', 'end_date', self.gf('django.db.models.fields.DateTimeField')())
