...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'order_ordernote', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Users'], null=True))

        # Changing field 'Order.user'
        db.alter_column(u'order_order', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['accounts.Users']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.user'
        db.alter_column(u'order_order', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], on_delete=models.SET_NULL))
