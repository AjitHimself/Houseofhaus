...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Line.is_rent'
        db.add_column(u'order_line', 'is_rent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Line.rent_start_date'
        db.add_column(u'order_line', 'rent_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Line.period'
        db.add_column(u'order_line', 'period',
                      self.gf('django.db.models.fields.IntegerField')(max_length=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Line.is_rent'
        db.delete_column(u'order_line', 'is_rent')

        # Deleting field 'Line.rent_start_date'
        db.delete_column(u'order_line', 'rent_start_date')

        # Deleting field 'Line.period'
        db.delete_column(u'order_line', 'period')
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'baskets'", 'null': 'True', 'to': u"orm['accounts.Users']"}),
        ...
        u'order.line': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_rent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'rent_start_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'order.order': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "'INR'", 'max_length': '12'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'orders'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['accounts.Users']"})
        },
        ...
        u'order.ordernote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Users']", 'null': 'True'})
        },
