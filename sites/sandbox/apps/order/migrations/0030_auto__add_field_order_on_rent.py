...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'order.order': {
            ...
            'on_rent': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'partner.stockrecord': {
            ...
            'rent_deposit': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '2', 'blank': 'True'})
        },
        u'sites.site': {
