...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Users.proffesion'
        db.add_column(u'accounts_users', 'proffesion',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Users.website'
        db.add_column(u'accounts_users', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Users.location'
        db.add_column(u'accounts_users', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Users.proffesion'
        db.delete_column(u'accounts_users', 'proffesion')

        # Deleting field 'Users.website'
        db.delete_column(u'accounts_users', 'website')

        # Deleting field 'Users.location'
        db.delete_column(u'accounts_users', 'location')
    ...
    models = {
        u'accounts.users': {
            ...
            'proffesion': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
