...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Users.twitter_link'
        db.add_column(u'accounts_users', 'twitter_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Users.facebook_link'
        db.add_column(u'accounts_users', 'facebook_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Users.instagram_link'
        db.add_column(u'accounts_users', 'instagram_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Users.twitter_link'
        db.delete_column(u'accounts_users', 'twitter_link')

        # Deleting field 'Users.facebook_link'
        db.delete_column(u'accounts_users', 'facebook_link')

        # Deleting field 'Users.instagram_link'
        db.delete_column(u'accounts_users', 'instagram_link')
    ...
    models = {
        u'accounts.users': {
            ...
            'facebook_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'user_set'", 'blank': 'True', 'to': u"orm['auth.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instagram_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
            ...
            'twitter_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
