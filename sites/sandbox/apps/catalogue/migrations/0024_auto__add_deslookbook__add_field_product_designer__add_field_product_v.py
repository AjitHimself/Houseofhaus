...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'DesLookbook'
        db.delete_table(u'catalogue_deslookbook')

        # Removing M2M table for field products on 'DesLookbook'
        db.delete_table(db.shorten_name(u'catalogue_deslookbook_products'))

        # Deleting field 'Product.designer'
        db.delete_column(u'catalogue_product', 'designer_id')
    ...
    models = {
        ...
        u'catalogue.deslookbook': {
            ...
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'des_product'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalogue.Product']"})
        },
        u'catalogue.option': {
