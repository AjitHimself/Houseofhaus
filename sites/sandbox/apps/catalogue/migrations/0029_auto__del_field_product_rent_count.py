...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.rent_count'
        db.delete_column(u'catalogue_product', 'rent_count')


    def backwards(self, orm):
        # Adding field 'Product.rent_count'
        db.add_column(u'catalogue_product', 'rent_count',
