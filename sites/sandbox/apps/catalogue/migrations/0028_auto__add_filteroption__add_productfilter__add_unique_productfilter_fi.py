...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilterOption'
        db.create_table(u'catalogue_filteroption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filters', self.gf('django.db.models.fields.related.ForeignKey')(related_name='options', to=orm['catalogue.FilterType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
        ))
        db.send_create_signal(u'catalogue', ['FilterOption'])

        # Adding model 'ProductFilter'
        db.create_table(u'catalogue_productfilter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filters', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.FilterType'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_filters', to=orm['catalogue.Product'])),
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.FilterOption'])),
        ))
        db.send_create_signal(u'catalogue', ['ProductFilter'])

        # Adding unique constraint on 'ProductFilter', fields ['filters', 'product']
        db.create_unique(u'catalogue_productfilter', ['filters_id', 'product_id'])

        # Adding model 'FilterType'
        db.create_table(u'catalogue_filtertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_filters', to=orm['catalogue.Category'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
        ))
        db.send_create_signal(u'catalogue', ['FilterType'])

        # Adding unique constraint on 'FilterType', fields ['category', 'name']
        db.create_unique(u'catalogue_filtertype', ['category_id', 'name'])

        # Deleting field 'Product.on_rent'
        db.delete_column(u'catalogue_product', 'on_rent')

        # Deleting field 'Product.video'
        db.delete_column(u'catalogue_product', 'video')

        # Adding M2M table for field filter_options on 'Product'
        m2m_table_name = db.shorten_name(u'catalogue_product_filter_options')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'catalogue.product'], null=False)),
            ('filteroption', models.ForeignKey(orm[u'catalogue.filteroption'], null=False))
        ))
        db.create_unique(m2m_table_name, ['product_id', 'filteroption_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FilterType', fields ['category', 'name']
        db.delete_unique(u'catalogue_filtertype', ['category_id', 'name'])

        # Removing unique constraint on 'ProductFilter', fields ['filters', 'product']
        db.delete_unique(u'catalogue_productfilter', ['filters_id', 'product_id'])

        # Deleting model 'FilterOption'
        db.delete_table(u'catalogue_filteroption')

        # Deleting model 'ProductFilter'
        db.delete_table(u'catalogue_productfilter')

        # Deleting model 'FilterType'
        db.delete_table(u'catalogue_filtertype')

        # Adding field 'Product.on_rent'
        db.add_column(u'catalogue_product', 'on_rent',
        ...
        # Removing M2M table for field filter_options on 'Product'
        db.delete_table(db.shorten_name(u'catalogue_product_filter_options'))
    ...
    models = {
        ...
        u'catalogue.deslookbook': {
            'Meta': {'object_name': 'DesLookbook'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lookbooks'", 'null': 'True', 'to': u"orm['designer.Designer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True', 'null': 'True'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'lookbooks'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalogue.Product']"}),
