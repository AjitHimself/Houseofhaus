...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Designer.last_name'
        db.delete_column(u'designer_designer', 'last_name')

        # Deleting field 'Designer.first_name'
        db.delete_column(u'designer_designer', 'first_name')

        # Deleting field 'Designer.email'
        db.delete_column(u'designer_designer', 'email')

        # Adding field 'Designer.name'
        db.add_column(u'designer_designer', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Designer.designer'
        db.add_column(u'designer_designer', 'designer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Users'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Designer.last_name'
        db.add_column(u'designer_designer', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Designer.first_name'
        db.add_column(u'designer_designer', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Designer.email'
        db.add_column(u'designer_designer', 'email',
                      self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75, null=True),
                      keep_default=False)

        # Deleting field 'Designer.name'
        db.delete_column(u'designer_designer', 'name')

        # Deleting field 'Designer.designer'
        db.delete_column(u'designer_designer', 'designer_id')
