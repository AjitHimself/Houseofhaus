...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Designer.profile_pic'
        db.delete_column(u'designer_designer', 'profile_pic')

        # Deleting field 'Designer.name'
        db.delete_column(u'designer_designer', 'name')

        # Deleting field 'Designer.gender'
        db.delete_column(u'designer_designer', 'gender')

        # Deleting field 'Designer.date_joined'
        db.delete_column(u'designer_designer', 'date_joined')


    def backwards(self, orm):
        # Adding field 'Designer.profile_pic'
        db.add_column(u'designer_designer', 'profile_pic',
        ...
        # Adding field 'Designer.gender'
        db.add_column(u'designer_designer', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)

        # Adding field 'Designer.date_joined'
        db.add_column(u'designer_designer', 'date_joined',
