...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Designer.slug'
        db.add_column(u'designer_designer', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 7, 11, 0, 0), max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Designer.slug'
        db.delete_column(u'designer_designer', 'slug')
    ...
    models = {
        ...
        u'designer.designerpost': {
            ...
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'des'", 'null': 'True', 'to': u"orm['designer.Designer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
