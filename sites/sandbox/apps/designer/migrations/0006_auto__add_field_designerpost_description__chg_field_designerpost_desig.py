...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DesignerPost.description'
        db.add_column(u'designer_designerpost', 'description',
                      self.gf('django.db.models.fields.TextField')(default='text'),
                      keep_default=False)


        # Changing field 'DesignerPost.designer'
        db.alter_column(u'designer_designerpost', 'designer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['designer.Designer']))

    def backwards(self, orm):
        # Deleting field 'DesignerPost.description'
        db.delete_column(u'designer_designerpost', 'description')


        # Changing field 'DesignerPost.designer'
        db.alter_column(u'designer_designerpost', 'designer_id', self.gf('django.db.models.fields.related.ForeignKey')(default='des', to=orm['designer.Designer']))
    ...
    models = {
        ...
        u'designer.designerpost': {
            ...
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'default': "'des'", 'related_name': "'des'", 'null': 'True', 'to': u"orm['designer.Designer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
