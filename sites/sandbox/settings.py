...
# system time zone.
TIME_ZONE = 'Asia/Kolkata'  # 'America/Chicago' it was this by default 
...
# auth and allauth settings    mmm
LOGIN_REDIRECT_URL = '/'
SOCIALACCOUNT_QUERY_EMAIL = True
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'SCOPE': ['email', 'publish_stream','https://www.googleapis.com/auth/userinfo.profile'],
        'METHOD': 'oauth2' ,
        'AUTH_PARAMS': { 'access_type': 'online' },
        'device_id':'192.168.100.106',
        'device_name': 'VIVENKYAN'
    },
...
INTERNAL_IPS = ['192.168.100.104','255.255.255.0','192.168.100.1','192.168.100.109','192.168.100.106','192.168.1.3','127.0.0.1', '::1']
