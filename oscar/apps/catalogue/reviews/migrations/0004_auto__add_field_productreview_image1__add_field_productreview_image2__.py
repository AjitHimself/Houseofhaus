...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductReview.image1'
        db.add_column(u'reviews_productreview', 'image1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductReview.image2'
        db.add_column(u'reviews_productreview', 'image2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductReview.image3'
        db.add_column(u'reviews_productreview', 'image3',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductReview.image1'
        db.delete_column(u'reviews_productreview', 'image1')

        # Deleting field 'ProductReview.image2'
        db.delete_column(u'reviews_productreview', 'image2')

        # Deleting field 'ProductReview.image3'
        db.delete_column(u'reviews_productreview', 'image3')
    ...
    models = {
        ...
        u'reviews.productreview': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reviews'", 'null': 'True', 'to': u"orm['accounts.Users']"})
        },
        u'reviews.vote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'review_votes'", 'to': u"orm['accounts.Users']"})
        }
    }
