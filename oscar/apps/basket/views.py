...
class BasketAddView(FormView):
    ...
    def form_valid(self, form):
        ...
        self.request.basket.add_product(
            form.product, False, form.cleaned_data['quantity'],
...
class BasketAddRentView(FormView):
    ...
    I have purposely created this extra view so that I can convey 
    Rental price to the system in spite of Retail price
    """
    form_class = AddToBasketForm
    product_model = get_model('catalogue', 'product')
    ...
    def post(self, request, *args, **kwargs):
        self.product = shortcuts.get_object_or_404(
            self.product_model, pk=kwargs['pk'])
        return super(BasketAddRentView, self).post(request, *args, **kwargs)
    ...
    def form_valid(self, form):
        ...
        # @ajit: Passing is_rent flag to the product addition to the basket model
        ...
        return super(BasketAddRentView, self).form_valid(form)
