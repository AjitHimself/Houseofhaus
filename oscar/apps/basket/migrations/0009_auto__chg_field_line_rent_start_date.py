...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Line.rent_start_date'
        db.alter_column(u'basket_line', 'rent_start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Line.rent_start_date'
        db.alter_column(u'basket_line', 'rent_start_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
