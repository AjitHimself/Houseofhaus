...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'basket_line', 'rent_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Line.period'
        db.add_column(u'basket_line', 'period',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'basket_line', 'rent_start_date')

        # Deleting field 'Line.period'
        db.delete_column(u'basket_line', 'period')
    ...
    models = {
        ...
        u'basket.line': {
            ...
            'rent_start_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'stockrecord': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'basket_lines'", 'to': u"orm['partner.StockRecord']"})
        },
